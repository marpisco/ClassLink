    ...
    case "apagar":
        ...
        try {
            ...
            if ($result->num_rows > 0) {
                throw new Exception("Existem reservas associadas a este utilizador. Por segurança, é necessária uma intervenção manual de um Administrador.");
            }
            $stmt->close();
        } catch (Exception $e) {
...
(function() {
    ...
    function createUserCard(user) {
        ...
        const internalDomain = <?php echo json_encode(get_app_config('internal_email_domain', ''), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
