...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center flex-column">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" method="POST" class="d-flex align-items-center">
            <?= csrf_token_field(); ?>
    ...
    if (isset($_POST['sala']) || isset($_GET['sala'])) {
        ...
        if ($isAutonomous) {
            if ($isInternalUser) {
                ...
                echo "<div class='alert alert-warning mb-3' style='width: 100%;'><strong>Reserva Autónoma:</strong> Esta sala é de reserva autónoma, mas não tem permissão para reservas autónomas, por isso a sua reserva necessita de aprovação por um administrador.</div>";
            }
        }
