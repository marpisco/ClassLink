    ...
    if (isset($_POST['sala']) || isset($_GET['sala'])) {
        ...
        if ($isAutonomous) {
            if ($isInternalUser) {
                ...
                echo "<div class='alert alert-warning mb-3' style='width: 100%;'><strong>Reserva Autónoma:</strong> Esta sala é de reserva autónoma, mas não tem permissão para a criar, pelo qual a sua reserva necessita de aprovação por um administrador.</div>";
            }
        }
